...
// Global Vars
final static int NUMOFSCENES = 8;
final static boolean VERBOSE = false;
final static int FRAMERATE = 60;
final static int windowWidth = window.innerWidth;
final static int windowHeight = window.innerHeight;
...
let sceneDoms;
let scenes[];
int sceneAllocations = new int [] {0, 1, 2, 2, 2, 3, 4, 5, 6, 7};
...
float wFrequencyAmplitude = new int []{1, 1, 1};
